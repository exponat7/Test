...
namespace TestApplication.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            CustomSignInManager<CustomIdentityUser> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new CustomIdentityUser { UserName = Input.Email, Email = Input.Email , IsActive = true};//Так как нет админки, то сразу активируем пользователя
